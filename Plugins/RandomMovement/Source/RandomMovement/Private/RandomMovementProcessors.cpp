...
void URandomMovementSignalProcessor::SignalEntities(FMassEntityManager& EntityManager, FMassExecutionContext& Context, FMassSignalNameLookup& EntitySignals)
{
	EntityQuery.ForEachEntityChunk(Context, [](FMassExecutionContext& Context)
		{
			const auto& Transforms = Context.GetFragmentView<FTransformFragment>();
...
/**
 * 初始化URandomMovementSignalProcessor处理器
 * 
